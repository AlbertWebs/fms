            ...
            <div class="p-6">
                ...
                <div class="space-y-3 mb-6">
                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-gray-200">
                        ...
                        <span class="text-sm font-bold text-gray-600">{{ number_format($counts['clients']) }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-gray-200">
                        ...
                        <span class="text-sm font-bold text-gray-600">{{ number_format($counts['files']) }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-gray-200">
                        ...
                        <span class="text-sm font-bold text-gray-600">{{ number_format($counts['categories']) }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-gray-200">
                        ...
                        <span class="text-sm font-bold text-gray-600">{{ number_format($counts['file_requests']) }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-gray-200">
                        ...
                        <span class="text-sm font-bold text-gray-600">{{ number_format($counts['audit_logs']) }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-gray-200">
                        ...
                        <span class="text-sm font-bold text-gray-600">{{ number_format($counts['email_logs']) }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-gray-200">
                        ...
                        <span class="text-sm font-bold text-gray-600">{{ number_format($counts['roles']) }} roles, {{ number_format($counts['permissions']) }} permissions</span>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.purge.execute') }}" 
