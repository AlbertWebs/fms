<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl border-2 border-indigo-200/60 p-6 hover:border-indigo-300 hover:shadow-xl transition-all duration-200 group transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mt-1">{{ $totalFiles }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 rounded-2xl border-2 border-emerald-200/60 p-6 hover:border-emerald-300 hover:shadow-xl transition-all duration-200 group transform hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent mt-1">{{ $categoriesCount }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="mt-1">
                            ...
                            @endphp
                            <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold border shadow-sm {{ $statusColor }}">
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-gradient-to-br from-indigo-50/50 to-purple-50/30 rounded-xl border-2 border-indigo-200 p-5">
                        ...
                        <dd class="text-base font-bold text-gray-900">{{ $client->name }}</dd>
                    </div>
                    <div class="bg-gradient-to-br from-purple-50/50 to-pink-50/30 rounded-xl border-2 border-purple-200 p-5">
                        ...
                        <dd class="text-base font-semibold text-gray-900">
                            @if($client->email)
                                <a href="mailto:{{ $client->email }}" class="text-indigo-600 hover:text-indigo-700 hover:underline">
                                    {{ $client->email }}
                                </a>
                            @else
                    ...
                    <div class="bg-gradient-to-br from-pink-50/50 to-violet-50/30 rounded-xl border-2 border-pink-200 p-5">
                        ...
                        <dd class="text-base font-semibold text-gray-900">
                            @if($client->phone)
                                <a href="tel:{{ $client->phone }}" class="text-purple-600 hover:text-purple-700 hover:underline">
                                    {{ $client->phone }}
                                </a>
                            @else
                                <span class="text-gray-400">N/A</span>
                    ...
                    <div class="bg-gradient-to-br from-violet-50/50 to-indigo-50/30 rounded-xl border-2 border-violet-200 p-5">
                        ...
                        <dd class="text-base font-semibold text-gray-900 font-mono">{{ $client->kra_pin ?? 'N/A' }}</dd>
                    </div>
                    <div class="bg-gradient-to-br from-emerald-50/50 to-teal-50/30 rounded-xl border-2 border-emerald-200 p-5">
                        ...
                        <dd class="text-base font-semibold text-gray-900">{{ $client->created_at->format('M d, Y') }}</dd>
                    </div>
                    <div class="bg-gradient-to-br from-cyan-50/50 to-blue-50/30 rounded-xl border-2 border-cyan-200 p-5">
                        ...
                        <dd class="text-base font-semibold text-gray-900">{{ $client->updated_at->format('M d, Y') }}</dd>
                    </div>
                </div>

                @if($client->company_name || $client->company_address || $client->company_website || $client->company_registration_number)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @if($client->company_name)
                                <div class="bg-gradient-to-br from-purple-50/50 to-pink-50/30 rounded-xl border-2 border-purple-200 p-5">
                                    ...
                                    <dd class="text-base font-bold text-gray-900">{{ $client->company_name }}</dd>
                                </div>
                            @endif
                            @if($client->company_registration_number)
                                <div class="bg-gradient-to-br from-violet-50/50 to-indigo-50/30 rounded-xl border-2 border-violet-200 p-5">
                                    ...
                                    <dd class="text-base font-semibold text-gray-900">{{ $client->company_registration_number }}</dd>
                                </div>
                            @endif
                            @if($client->company_website)
                                <div class="bg-gradient-to-br from-pink-50/50 to-violet-50/30 rounded-xl border-2 border-pink-200 p-5">
                                    ...
                                    <dd class="text-base font-semibold text-gray-900">
                                        <a href="{{ $client->company_website }}" target="_blank" class="text-indigo-600 hover:text-indigo-700 hover:underline">
                            ...
                            @if($client->company_address)
                                <div class="bg-gradient-to-br from-indigo-50/50 to-purple-50/30 rounded-xl border-2 border-indigo-200 p-5 md:col-span-2 lg:col-span-3">
                                    ...
                                    <dd class="text-base font-semibold text-gray-900">{{ $client->company_address }}</dd>
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                @if($client->contact_name || $client->contact_email || $client->contact_phone || $client->contact_position)
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            @if($client->contact_name)
                                <div class="bg-gradient-to-br from-pink-50/50 to-violet-50/30 rounded-xl border-2 border-pink-200 p-5">
                                    ...
                                    <dd class="text-base font-bold text-gray-900">{{ $client->contact_name }}</dd>
                                </div>
                            @endif
                            @if($client->contact_position)
                                <div class="bg-gradient-to-br from-violet-50/50 to-indigo-50/30 rounded-xl border-2 border-violet-200 p-5">
                                    ...
                                    <dd class="text-base font-semibold text-gray-900">{{ $client->contact_position }}</dd>
                                </div>
                            @endif
                            @if($client->contact_email)
                                <div class="bg-gradient-to-br from-purple-50/50 to-pink-50/30 rounded-xl border-2 border-purple-200 p-5">
                                    ...
                                    <dd class="text-base font-semibold text-gray-900">
                                        <a href="mailto:{{ $client->contact_email }}" class="text-indigo-600 hover:text-indigo-700 hover:underline">
                            ...
                            @if($client->contact_phone)
                                <div class="bg-gradient-to-br from-pink-50/50 to-violet-50/30 rounded-xl border-2 border-pink-200 p-5">
                                    ...
                                    <dd class="text-base font-semibold text-gray-900">
                                        <a href="tel:{{ $client->contact_phone }}" class="text-purple-600 hover:text-purple-700 hover:underline">
        ...
        <div class="bg-gradient-to-br from-white via-indigo-50/30 to-purple-50/30 rounded-2xl border-2 border-indigo-200/60 shadow-xl overflow-hidden backdrop-blur-sm">
            <div class="px-8 py-6 border-b-2 border-indigo-200/50 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('clients.timeline', $client) }}" class="text-sm font-semibold text-indigo-600 hover:text-indigo-700 hover:underline flex items-center">
            ...
            <div class="p-8">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($files as $file)
                                    <tr class="hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-purple-50/30 transition-all duration-150 {{ $loop->even ? 'bg-gray-50/30' : 'bg-white' }} cursor-pointer group" onclick="window.location.href='{{ route('files.show', $file) }}'">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-sm font-bold text-gray-900 group-hover:text-indigo-700 transition-colors">{{ $file->original_name }}</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap" onclick="event.stopPropagation()">
                                            ...
                                            @endphp
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold border shadow-sm {{ $statusColor }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" onclick="event.stopPropagation()">
                                            <x-table-action-dropdown :item="$file">
                                                @can('files.download')
                                                    <a href="{{ route('files.download', $file) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50 hover:text-blue-700 transition-colors">Download</a>
                                                @endcan
                                                @can('files.view')
                                                    <a href="{{ route('files.show', $file) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 hover:text-indigo-700 transition-colors">View Details</a>
                                                @endcan
                ...
                @else
                    <div class="text-center py-16">
                        ...
                        @can('files.upload')
                            <div class="mt-6">
                                <a href="{{ route('files.create') }}?client_id={{ $client->id }}">
        ...
        <div class="flex items-center justify-center gap-4 pt-6">
            @can('files.upload')
                <a href="{{ route('files.create') }}?client_id={{ $client->id }}" class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 border border-transparent rounded-xl font-bold text-sm text-white hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                    <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    Upload File
            ...
            @endcan
            <a href="{{ route('clients.index') }}" class="inline-flex items-center justify-center px-6 py-3 bg-white border-2 border-gray-300 rounded-xl font-semibold text-sm text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm hover:shadow-md">
                <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
