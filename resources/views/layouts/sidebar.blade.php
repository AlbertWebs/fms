    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto" style="scrollbar-width: thin; scrollbar-color: rgb(75 85 99) rgb(17 24 39);">
        ...
        @can('users.manage')
            <div class="pt-4 mt-4 border-t border-indigo-200/60">
                ...
                <a href="{{ route('admin.purge.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-900/20 rounded-lg border border-red-700/30 hover:border-red-600/50 shadow-sm hover:shadow-md transition-all duration-200 {{ request()->routeIs('admin.purge.*') ? 'bg-red-900/30 border-red-600/50' : '' }}">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
