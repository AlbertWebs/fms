...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="apple-mobile-web-app-title" content="{{ \App\Models\Setting::get('company_name', config('app.name', 'FileCR')) }}">
                ...
                <div class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-xl shadow-2xl p-5 border-2 border-white/20">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-white/90 text-sm mb-4">Install {{ \App\Models\Setting::get('company_name', config('app.name', 'FileCR')) }} for a better experience</p>
