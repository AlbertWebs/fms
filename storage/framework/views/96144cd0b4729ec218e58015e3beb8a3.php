...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg border border-indigo-200/50 shadow-sm p-4">
            <form method="GET" action="<?php echo e(route('audit-logs.index')); ?>" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['name' => 'action','placeholder' => 'Action','value' => ''.e(request('action')).'','class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'action','placeholder' => 'Action','value' => ''.e(request('action')).'','class' => 'w-full']); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-indigo-50/30 transition-colors border-b border-gray-100/50 <?php echo e($loop->even ? 'bg-gray-50/30' : ''); ?>">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($log->user->name ?? 'System'); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-500"><?php echo e($log->description); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
...
<?php endif; ?><?php /**PATH C:\projects\filecr\resources\views/audit-logs/index.blade.php ENDPATH**/ ?>