        ...
        <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
            <div class="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <p class="text-sm text-amber-800">
                    ...
                    <button form="send-verification" class="underline font-medium hover:text-amber-900 transition-colors">
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                ...
                ><?php echo e(__('Profile updated successfully.')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH C:\xampp\htdocs\fms\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>