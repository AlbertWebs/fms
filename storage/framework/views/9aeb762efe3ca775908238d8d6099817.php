...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: white; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        <p style="margin-top: 0;">Dear <?php echo e($fileRequest->client->name); ?>,</p>
        ...
        <?php if($fileRequest->category || $fileRequest->financial_year): ?>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="<?php echo e(route('file-requests.upload', $fileRequest->token)); ?>" 
        ...
        <p style="color: #6b7280; font-size: 14px;">
            <strong>Important:</strong> This link will expire on <?php echo e($fileRequest->expires_at->format('F d, Y')); ?>.
        </p>
...
<?php /**PATH C:\projects\filecr\resources\views/emails/file-request.blade.php ENDPATH**/ ?>