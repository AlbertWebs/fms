...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Upload File - <?php echo e(config('app.name', 'Laravel')); ?></title>
            ...
            <div class="max-w-3xl w-full space-y-6">
                ...
                <div class="bg-gradient-to-br from-white via-indigo-50/30 to-purple-50/30 rounded-2xl border-2 border-indigo-200/60 shadow-xl overflow-hidden backdrop-blur-sm">
                    <div class="px-8 py-6 border-b-2 border-indigo-200/50 bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10">
                        <h2 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($fileRequest->title); ?></h2>
                        <?php if($fileRequest->description): ?>
                            <p class="text-sm font-medium text-gray-600 mt-2"><?php echo e($fileRequest->description); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($fileRequest->client->name); ?></p>
                                </div>
                            </div>
                            <?php if($fileRequest->category): ?>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-gray-900"><?php echo e($fileRequest->category->name); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <!-- Upload Form -->
                <div class="bg-gradient-to-br from-white via-indigo-50/30 to-purple-50/30 rounded-2xl border-2 border-indigo-200/60 shadow-xl overflow-hidden backdrop-blur-sm">
                    <form method="POST" action="<?php echo e(route('file-requests.upload', $fileRequest->token)); ?>" 
...
<?php /**PATH C:\projects\filecr\resources\views/file-requests/upload.blade.php ENDPATH**/ ?>